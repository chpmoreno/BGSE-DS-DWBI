-- Drop the database (for running all the script)

drop database ecommerce;

-- Create de database ecommerce
...
-- Create the table products. Unitprice type based on stackoverflow.
...
-- Create the table suppliers. Homepage type based on stackoverflow.
...
-- Create the table categories. Length Description based on stackoverflow.
...
-- I had a problem with datetime in the order table when it is '0000-00-00'.
-- On Stackoverflow I found that the error is because of the sql mode which 
-- can be strict mode as per latest MYSQL 5.7 documentation. To solve the problem I use:
set sql_mode = '';
